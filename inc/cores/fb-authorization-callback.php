...
if ($body != '') {
    ...
    if (isset($params['access_token']) || isset($body_response->access_token)) {
        ...
        update_option('polar_extra_settings', $account_extra_details);
        $_SESSION['polar_message'] = __('Account authorized successfully.Now you can go for posting.', 'polar');
        $redirect_url = admin_url() . 'admin.php?page=polar';
        // die($redirect_url);
